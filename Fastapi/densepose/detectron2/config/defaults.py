...
# To test on images of different number of channels, just set different mean & std.
...
# Number of regions per image used to test RPN
...
# The reference number of workers (GPUs) this config is meant to test with.
...
# The period (in terms of steps) for minibatch visualization at test time.
# Set to 0 to disable.
_C.VIS_PERIOD = 0
