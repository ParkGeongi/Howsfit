    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            pre_nms_topk (tuple[float]): (test, test) that represents the
                number of top k proposals to select before NMS, in
                training and testing.
            post_nms_topk (tuple[float]): (test, test) that represents the
        ...
        # Map from self.training state to test/test settings
