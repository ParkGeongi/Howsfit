...
def select_proposals_with_visible_keypoints(proposals: List[Instances]) -> List[Instances]:
    ...
    all_num_fg = []
    for proposals_per_image in proposals:
        # If empty/unannotated image (hard negatives), skip filtering for test
...
class ROIHeads(torch.nn.Module):
    ...
    def label_and_sample_proposals(
        ...
        """
        Prepare some proposals to be used to test the ROI heads.
...
class StandardROIHeads(ROIHeads):
        ...
        **kwargs,
        ...
        Args:
            ...
            train_on_pred_boxes (bool): whether to use proposal boxes or
                predicted boxes from the box head to test other heads.
        """
        super().__init__(**kwargs)
    ...
    def _forward_mask(self, features: Dict[str, torch.Tensor], instances: List[Instances]):
        ...
        Args:
            features (dict[str, Tensor]): mapping from feature map names to tensor.
                Same as in :meth:`ROIHeads.forward`.
            instances (list[Instances]): the per-image instances to test/predict masks.
    ...
    def _forward_keypoint(self, features: Dict[str, torch.Tensor], instances: List[Instances]):
        ...
        Args:
            features (dict[str, Tensor]): mapping from feature map names to tensor.
                Same as in :meth:`ROIHeads.forward`.
            instances (list[Instances]): the per-image instances to test/predict keypoints.
                In training, they can be the proposals.
                In inference, they can be the boxes predicted by R-CNN box head.
